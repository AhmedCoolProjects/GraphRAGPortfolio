...
export const EvervaultCard = ({
  ...
  return (
    <div
      className={cn(
        "  bg-transparent z-10  flex items-center justify-center w-full h-full absolute",
        className
      )}
    >
      <div
        onMouseMove={onMouseMove}
        className="group/card overflow-hidden w-full absolute  bg-transparent flex items-center justify-center h-full"
      >
        <CardPattern
          mouseX={mouseX}
          mouseY={mouseY}
