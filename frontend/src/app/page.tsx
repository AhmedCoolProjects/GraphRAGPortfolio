...
const SOCIALS = {
  ...
  huggingface: "https://huggingface.co/ahmedBargady",
  x: "https://x.com/AhmedBargady",
        ...
        <div className="max-w-5xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              className="text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors flex items-center justify-center"
              target="_blank"
              rel="noopener noreferrer"
              title="HuggingFace"
            >
